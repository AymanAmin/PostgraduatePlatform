...
export class ListSpecializationsComponent implements OnInit {
  ...
  // Label Data
  lb_SpeInfo: any; lb_SpeInfoD: any; lb_EngName: any; lb_ArName: any;
  ...
  GetLabelName(LangCode: any) {
    if (LangCode == "us-en") {
      this.lb_SpeInfo = "Specialization Info";
      this.lb_SpeInfoD = "Please fill all details for the specialization";
      ...
      this.lb_Id = "Spe No";
      this.lb_Search = "Specialization List";
      this.lb_SearchD = "You can search for any field in the table by typing here";
      this.lb_Action = "Action"
    }
    else {
      this.lb_SpeInfo = "بيانات التخصص";
      this.lb_SpeInfoD = "الرجاء تعبئة جميع بيانات التخصص";
